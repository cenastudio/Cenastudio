          ...
          <div className="p-4 space-y-3">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 rounded border border-frame-gray-3 px-3 py-2 text-sm transition-colors hover:border-frame-gray-4"
              >
              ...
              {videoFile.status === 'complete' && (
                <button
                  onClick={() => fileInputRef.current?.click()}
                  className="flex-1 rounded bg-frame-orange px-3 py-2 text-sm text-frame-black transition-colors hover:bg-frame-orange/90"
                >
