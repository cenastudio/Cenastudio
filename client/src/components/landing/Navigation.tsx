    ...
    <nav className="landing-nav fixed inset-x-0 top-0 z-50 px-4 py-5 sm:px-6 lg:py-7">
      <div className="landing-shell flex min-h-12 items-center justify-between gap-4">
        ...
        <div className="hidden items-center gap-1 lg:flex">
          {NAVIGATION.map((link) => (
            <button
              ...
              className="min-h-8 border-b border-transparent px-3 text-[0.68rem] text-white/65 transition-colors hover:border-frame-orange hover:text-white"
            >
        ...
        <button
          ...
          className="grid h-10 w-10 place-items-center rounded-md border border-white/15 bg-black/30 text-white backdrop-blur-xl transition-colors hover:border-frame-orange/60 sm:hidden"
