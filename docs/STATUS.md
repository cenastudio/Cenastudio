...
3. `.kiro/specs/auditoria-ux-2026-07/` — **14 de 47 tasks feitas**. Fase A
   ...
   acesso em até 2 toques para as áreas visíveis. Validação já executada nesta
   frente: `npm run check`,
   ...
   `npx playwright test --grep "@fase1"`. Próxima task: B2.2 `ProjectNav`.
