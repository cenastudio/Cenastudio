...
export const PRICING = [
  {
    ...
    price: "R$0",
    period: "/mês",
    description: "Teste o Cena por 14 dias com tudo liberado",
    note: "1 projeto ativo após trial",
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      "Templates profissionais de projeto",
      "Shot list com drag-and-drop",
      "Decupagem com IA",
  ...
  },
  {
    ...
    price: "R$399",
    period: "/mês",
    description: "Para produtoras médias com controle operacional (5-15 pessoas)",
    ...
    features: [
      ...
      "Shot list avançado com cenas",
      "Equipe e colaboradores (3 usuários)",
      "Webhooks para automação",
      "Exportar cronograma para agenda (.ics)",
      "Gerenciamento de sessões avançado",
      "Budget Tracking & Control 🔥",
      "Equipment Inventory 🔥",
      "Biblioteca de assets (100GB)",
      "Relatórios operacionais completos",
      "Suporte prioritário (24h)",
    ],
    cta: { label: "Ativar Studio", href: "#" },
    highlight: false,
  },
  {
    id: "whitelabel" as PlanTier,
    tier: "// White-Label",
    price: "R$1.499",
    period: "/mês",
    description: "Para produtoras estabelecidas que querem marca própria (15-50 pessoas)",
    roi: "💎 Posicionamento premium, sem custos de desenvolvimento",
    features: [
      "Clientes ilimitados",
      "2.000 gerações IA/mês",
      "Tudo do Studio +",
      "Domínio customizado (seu-site.com)",
      "Logo e cores personalizadas",
      "Email personalizado",
      "Portal 100% white-label",
      "Remoção de marca Cena Studio",
      "Equipe e colaboradores (10 usuários)",
      "Biblioteca de assets (500GB)",
      "Onboarding dedicado (2h)",
      "Suporte prioritário (4h)",
      "SLA 99.5%",
    ],
    cta: { label: "Solicitar Proposta", href: "#contact" },
    highlight: false,
  },
  {
    ...
    price: "R$5.000+",
    period: "/mês — consulta",
    description: "Para redes de produtoras, holdings, agências grandes (50+ pessoas)",
    roi: "🏢 Múltiplas marcas, API privada, SLA 99.9%",
    features: [
      "Tudo ilimitado",
      "Gerações IA ilimitadas",
      "Múltiplas marcas white-label",
      "API privada para integrações",
      "Assets ilimitados (custom storage)",
      "Usuários ilimitados",
      "Integração Stripe 1% fee",
      "Onboarding dedicado (8h)",
